...
public class AuthorController {
	...
	@GetMapping("/authors")
	public List<Author> getAllAuthors() throws InterruptedException, ExecutionException{
	...
	private List<Author> readFromRedis() throws InterruptedException, ExecutionException {
